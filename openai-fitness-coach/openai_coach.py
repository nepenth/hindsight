...
def get_or_create_assistant():
    ...
    if os.path.exists(ASSISTANT_ID_FILE):
        ...
        try:
            ...
            print("⚠️  Saved assistant not found, creating new one...")
...
def chat(assistant, thread_id: str, user_message: str, stream: bool = True) -> str:
    ...
    try:
            ...
            for attempt in range(max_attempts):
                try:
                    ...
                    if attempt > 30 and run.status in ["in_progress", "requires_action"]:
                        print("   ⚠️  Run taking too long, attempting to cancel...")
                    ...
                    if "not found" not in str(inner_e).lower():
                        print(f"   ⚠️  Error checking run status: {inner_e}")
                    break
        ...
        try:
            ...
            print(f"   ⚠️  Could not retrieve message: {msg_e}")
