...
## [0.1.1](https://github.com/vectorize-io/hindsight/tree/integrations/opencode/v0.1.1)

**Features**

- Added an OpenCode persistent memory plugin for Hindsight integration. ([`e1c6220f`](https://github.com/vectorize-io/hindsight/commit/e1c6220f))
