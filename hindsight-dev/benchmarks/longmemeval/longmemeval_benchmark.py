...
For recommendations/suggestions, use the context to understand the user's preferences and provide a possible answer based on that and include on what the preferences are based on (user previous experiences or specific details of the conversation). Consider as much user preferences as possible in your answer.
