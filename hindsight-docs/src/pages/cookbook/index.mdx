...
<CookbookGrid
  items={[
    {
      title: "Agno + Hindsight Memory",
      href: "/cookbook/applications/agno-memory",
      description: "Agno agents with persistent long-term memory and per-user banks via Hindsight",
