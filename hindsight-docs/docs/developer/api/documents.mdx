...
Change the tags on an existing document — and all its memory units — without re-processing the content. This is useful when you retained a document with wrong or missing tags and want to fix the visibility scope without consuming LLM tokens.

<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={documentsPy} section="document-update-tags" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={documentsMjs} section="document-update-tags" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
